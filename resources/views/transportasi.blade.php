							...
							<div class="row align-items-center mb-3">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 ordering">
									<div class="filter_wraps">
										<div class="dl">
											<div id="main2">
												<a href="javascript:void(0)" class="btn btn-theme arrow-btn filter_open" onclick="openNav()" id="open2">Armada<span><i class="fas fa-arrow-alt-circle-right"></i></span></a>
											</div>
										</div>
								...
								<div class="col-lg-4 col-md-6">
									<div class="education_block_grid">
										...
										<div class="col-lg-12 col-md-6">
											<div class="ed_detail_wrap">
												<ul class="list_ed_detail2">
													<li class="tag-2"></i><strong>Durasi:</strong>12 Jam {{ "Rp " . number_format($item->harga_12,0,',','.') }}
														<p>MOBIL + DRIVER DILUAR OPERASIONAL (DAKOT)</p>
													</li>
													<li class="tag-1"></i><strong>Durasi:</strong>12 Jam All IN {{ "Rp " . number_format($item->harga_12_all,0,',','.') }}
														<p>MOBIL + DRIVER OPERASIONAL (DAKOT)</p></li>
													<li class="tag-3"></i><strong>Durasi:</strong>Full Day {{ "Rp " . number_format($item->harga_full,2,',','.') }}
														<p>MOBIL + DRIVER DILUAR OPERASIONAL (DAKOT)</p>
													</li>
													<li class="tag-4"></i><strong>Durasi:</strong>Full Day All IN {{ "Rp " . number_format($item->harga_full_all,2,',','.') }}
										...
										<div class="ed_view_link">
											...
											<a href="https://wa.me/{{ $telp->telp1 }}" class="btn btn-theme enroll-btn" target="_blank">Hubungi Kami<i class="fab fa-whatsapp"></i></a>
											<a href="tel:+{{ $telp->telp1 }}" class="btn btn-theme enroll-btn" target="_blank">Hubungi Kami<i class="fas fa-phone"></i></a>
											@endforeach
										</div>
